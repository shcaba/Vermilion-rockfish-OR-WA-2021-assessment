...
## Stock{-}
This assessment reports the status of `r spp` (_`r spp.sci`_) off Oregon state using data through `r endyr`. `r Spp` are found in California and Washington waters, but those are treated separately in other stock assessments. The core range of `r spp` are outside of Oregon waters and in Califoria; this assessment thus considers a smaller population under different mangement considerations and exploitation histories than the California `r spp` stocks. There is substantial biogeographic separation in the populations off Oregon and Washington, thus justifying separation of those populations into different management units and stock assessments.
