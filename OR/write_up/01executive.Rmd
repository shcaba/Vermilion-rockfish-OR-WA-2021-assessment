...
## Stock{-}
This assessment reports the status of `r spp` (_`r spp.sci`_) off Oregon state using data through `r endyr`. `r Spp` are also found in California and Washington waters of teh U.S. West Coast, and those are treated in separate stock assessments. The core range of `r spp` is in California, thus outside of Oregon waters; this assessment thus considers a smaller population under different mangement considerations and exploitation histories than the larger California `r spp` stocks. There is substantial biogeographic separation in the populations off Oregon and Washington, thus justifying separation of those populations into different management units and stock assessments.
