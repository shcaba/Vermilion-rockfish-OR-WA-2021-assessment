...
\hypersetup{
  pdftitle={Status of Vermilion rockfish (Sebastes miniatus) along the US West - Oregon State coast in 2021},
  pdflang={en},
  hidelinks,
...
\vspace{1.5cm}
{\Large\textbf\newline{Status of Vermilion rockfish (\emph{Sebastes miniatus}) along the US West - Oregon State coast in 2021}}
\vfill
by\\
