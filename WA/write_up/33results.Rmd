...
The natural mortality for females and males was estimated at `r round(model$parameters[model$parameters$Label == "NatM_p_1_Fem_GP_1", 3])` and `r round(model$parameters[model$parameters$Label == "NatM_p_1_Mal_GP_1", 3],3)` yr^-1^, respectively. These values are below the mean prior value, but not unrreasonable given the corresponding longevities would be between 62 and 64 year old and the sampled max ages of 68 came from a fished population.
