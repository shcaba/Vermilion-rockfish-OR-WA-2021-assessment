...
caption = "Plot of year to the vermilion:black rockfish landing ratio. The linear model presented was used to predict vermilion catch from black rockfish catch for years of missing vermilion rockfish landings. The linear (y=ax+b) coefficients were a= 0.000016 and b= 0.029710",
...
caption = "Length-weight data and fits to sex-specific vermilion samples from the recreational fishery",
